...
class RegistrationTokenRepositoryTest extends TestCase
{
    ...
    {
        RegistrationTokenRepository::get()->create(new Registrant('test@email.com', 0));
    ...
    {
        $token = RegistrationTokenRepository::get()->create(new Registrant('test@email.com', 0));
    ...
    {
        $registrant = new Registrant('test@email.com', 0);
